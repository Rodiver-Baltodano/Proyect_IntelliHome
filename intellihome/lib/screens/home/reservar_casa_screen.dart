...
import 'package:intellihome/screens/home/reservar_confirmacion_screen.dart';
...
class _ReservarCasaScreenState extends State<ReservarCasaScreen> {
  ...
  Future<void> _continuarReserva() async {
    ...
    final disponible = await service.verificarDisponibilidad(
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ReservarConfirmacionScreen(
          casa: widget.casa,
